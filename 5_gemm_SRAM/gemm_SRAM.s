...
LBB0_4:
	...
	mv.stride.nram.nram	_ZZ12gemm16KernelPDhPaS0_jjjsE10input2NRAM, _ZZ12gemm16KernelPDhPaS0_jjjsE14input2NRAM_tmp, %r26, %r3, %r26, 63;
	mv.stride.nram.nram	[%r6], [%r7], %r26, %r3, %r26, 63;
	mv.stride.nram.nram	[%r8], [%r9], %r26, %r3, %r26, 63;
	mv.stride.nram.nram	[%r10], [%r11], %r26, %r3, %r26, 63;
...
LBB0_6:
	...
	eq.gpr.ptr 	%r79, %r83, 0x000000000000;
	bne.gpr.s32 	LBB0_6, %r79, 1;
LBB0_7:
