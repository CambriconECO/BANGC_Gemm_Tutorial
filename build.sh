...
cnas -O2 --mcpu x86_64 -i ./gemm_GDRAM.s -o ./gemm_GDRAM.o
...
cnas -O2 --mcpu x86_64 -i ./gemm_NRAM.s -o ./gemm_NRAM.o
...
cnas -O2 --mcpu x86_64 -i ./gemm_CONV.s -o ./gemm_CONV.o
...
cnas -O2 --mcpu x86_64 -i ./gemm_PARALL.s -o ./gemm_PARALL.o
...
cnas -O2 --mcpu x86_64 -i ./gemm_SRAM.s -o ./gemm_SRAM.o
...
cnas -O2 --mcpu x86_64 -i ./gemm_PIPELINE.s -o ./gemm_PIPELINE.o
